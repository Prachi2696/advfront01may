...
import cdaclogo2 from '../assets/img/cdacfooterlogo2.png'
...
const Footer2 = () => {
    ...
    return (
        <>
            <AppBar position="sticky" color="primary" style={{ top: 'auto', bottom:'0px', backgroundColor: theme.navbar.backgroundColor, color: 'white', height: isMobile ? '230px' :'auto', zIndex: '2' }}>
                <Toolbar>
                            ...
                            <TableContainer >
                                ...
                                <a
                                    ...
                                    <TableCell style={{ borderRight: '0px solid white', borderBottom: '0px' }}>
                                        {/* <a  target="_blank" href='https://advservice.epramaan.gov.in/dashboard/sitemap'><Button variant='text' color="inherit"style={{ fontSize: isMobile ? '7px' : '11px' }} >Sitemap </Button>|</a> */}
                                        {/* <a   target="_blank" href='https://advservice.epramaan.gov.in/dashboard/hyperlinking'>
                                        <Button variant='text' color="inherit" style={{ fontSize: isMobile ? '7px' : '11px' }}>Hyperlink Policy</Button>|

                                        </a>
                                        <a  target="_blank" href='https://advservice.epramaan.gov.in/dashboard/help'>
                                        <Button variant='text' color="inherit" style={{ fontSize: isMobile ? '7px' : '11px' }}>Help</Button>|

                                        </a>
                                        <a  target="_blank" href='https://advservice.epramaan.gov.in/dashboard/disclaimer'>
                                        <Button variant='text' color="inherit"  style={{ fontSize: isMobile ? '7px' : '11px' }}>Disclaimer</Button>|

                                        </a>
                                        <a  target="_blank" href='https://advservice.epramaan.gov.in/dashboard/copyright'>
                                        <Button variant='text' color="inherit"  style={{ fontSize: isMobile ? '7px' : '11px' }}>Copyright Policy</Button>|

                                        </a>
                                        <a  target="_blank" href='https://advservice.epramaan.gov.in/dashboard/privacy'>
                                        <Button variant='text' color="inherit"  style={{ fontSize: isMobile ? '7px' : '11px' }}>Privacy Policy</Button>|

                                        </a>
                                        <a  target="_blank" href='https://advservice.epramaan.gov.in/dashboard/terms'>
                                        <Button variant='text' color="inherit"  style={{ fontSize: isMobile ? '7px' : '11px' }}>Terms and Conditions</Button>

                                        </a> */}
                                        <Button variant='text' color="inherit" onClick={handlesitemap} style={{ fontSize: isMobile ? '7px' : '11px' }} >Sitemap </Button>|
                                        <Button variant='text' color="inherit" onClick={handleHyperlink} style={{ fontSize: isMobile ? '7px' : '11px' }}>Hyperlink Policy</Button>|
                                        <Button variant='text' color="inherit" onClick={handleHelp} style={{ fontSize: isMobile ? '7px' : '11px' }}>Help</Button>|
                                        <Button variant='text' color="inherit" onClick={handleDisclaimer} style={{ fontSize: isMobile ? '7px' : '11px' }}>Disclaimer</Button>|
                                        <Button variant='text' color="inherit" onClick={handleCopyright} style={{ fontSize: isMobile ? '7px' : '11px' }}>Copyright Policy</Button>|
                                        <Button variant='text' color="inherit" onClick={handlePrivacy} style={{ fontSize: isMobile ? '7px' : '11px' }}>Privacy Policy</Button>|
                                        <Button variant='text' color="inherit" onClick={handleTerms} style={{ fontSize: isMobile ? '7px' : '11px' }}>Terms and Conditions</Button>
