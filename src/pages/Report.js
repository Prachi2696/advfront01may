      ...
      <div style={{ marginLeft: 'auto', marginRight: 'auto', width: '80%', height: 'auto', paddingBottom: '500px' }}>
        ...
        {flag === "Monthly" && <>
          <Grid container spacing={1}>
            <Grid item xs={13} sm={8} md={3} lg={2} className="flex flex-col lg:flex-row justify-between"  >
              {/* <div>
              ...
              <div style={{ display: 'inline-block' }}>
                <FormControl sx={{ minWidth: 120 }} size="small">
                  ...
                  style={{ backgroundColor: theme.dropdownbg.backgroundColor, color: theme.typography.primary.paragraphbody }}>
                    ...
                    {/* </optgroup> */}
                    <option value="01" style={{ color: theme.typography.primary.paragraphbody, backgroundColor: theme.dropdownbg.backgroundColor }}>January</option>
                    <option value="02" style={{ color: theme.typography.primary.paragraphbody, backgroundColor: theme.dropdownbg.backgroundColor }}>February</option>
                    <option value="03" style={{ color: theme.typography.primary.paragraphbody, backgroundColor: theme.dropdownbg.backgroundColor }}>March</option>
                    <option value="04" style={{ color: theme.typography.primary.paragraphbody, backgroundColor: theme.dropdownbg.backgroundColor }}>April</option>
                    <option value="05" style={{ color: theme.typography.primary.paragraphbody, backgroundColor: theme.dropdownbg.backgroundColor }}>May</option>
                    <option value="06" style={{ color: theme.typography.primary.paragraphbody, backgroundColor: theme.dropdownbg.backgroundColor }}>June</option>
                    <option value="07" style={{ color: theme.typography.primary.paragraphbody, backgroundColor: theme.dropdownbg.backgroundColor }}>July</option>
                    <option value="08" style={{ color: theme.typography.primary.paragraphbody, backgroundColor: theme.dropdownbg.backgroundColor }}>August</option>
                    <option value="09" style={{ color: theme.typography.primary.paragraphbody, backgroundColor: theme.dropdownbg.backgroundColor }}>September</option>
                    <option value="10" style={{ color: theme.typography.primary.paragraphbody, backgroundColor: theme.dropdownbg.backgroundColor }}>October</option>
                    <option value="11" style={{ color: theme.typography.primary.paragraphbody, backgroundColor: theme.dropdownbg.backgroundColor }}>November</option>
                    <option value="12" style={{ color: theme.typography.primary.paragraphbody, backgroundColor: theme.dropdownbg.backgroundColor }}>December</option>
            ...
            <Grid item xs={13} sm={8} md={3} lg={2} >
              <div style={{ display: 'inline-block' }}>
                {/* <FormControl style={{ minWidth: 120 }} size="small" >
                 ...
                 <FormControl sx={{ minWidth: 120 }} size="small">
                  ...
                  <Select native defaultValue="" id="grouped-native-select" label="Year"
                   ...
                   style={{ backgroundColor: theme.dropdownbg.backgroundColor, color: theme.typography.primary.paragraphbody }}>
                    ...
                    {
                      years.map((year, index) => {
                        return <option key={`year${index}`} value={year} style={{ color: theme.typography.primary.paragraphbody, backgroundColor: theme.dropdownbg.backgroundColor }}>{year}</option>
                      })
                    }
                  </Select>
                </FormControl>
            ...
            <Grid item xs={13} sm={8} md={3} lg={2} >
              ...
              <FormControl sx={{ minWidth: 170 }} size="small">
                  ...
                  style={{ backgroundColor: theme.dropdownbg.backgroundColor, color: theme.typography.primary.paragraphbody }}>
                    ...
                    <option value="01" style={{ color: theme.typography.primary.paragraphbody, backgroundColor: theme.dropdownbg.backgroundColor }}>January-March</option>
                    <option value="04" style={{ color: theme.typography.primary.paragraphbody, backgroundColor: theme.dropdownbg.backgroundColor }}>April-June</option>
                    <option value="07" style={{ color: theme.typography.primary.paragraphbody, backgroundColor: theme.dropdownbg.backgroundColor }}>July-September</option>
                    <option value="10" style={{ color: theme.typography.primary.paragraphbody, backgroundColor: theme.dropdownbg.backgroundColor }}>October-December</option>
                  </Select>
                </FormControl>
              </div>
