    ...
    return (
        <>
            {/* <Card > */}
                ...
                <div style={{ marginLeft: 'auto', marginRight: 'auto', width: '80%', height: 'auto', paddingBottom: '500px',bottom:'0px',backgroundColor:theme.tablecontainer.backgroundColor  }}>
                    ...
                    <FormControl>
                        ...
                        >
                            <FormControlLabel size="small" value="quarter" onClick={handleflag} control={<Radio />} label="Quarterly" style={{color:theme.typography.primary.paragraphbody}} />
                                        ...
                                        {fetchingdataflag ?
                                            <>
                                                {spinnerforfetchingpdf ?
                                                    ...
                                                    :
                                                    <>
                                                        <Button size="medium" color="info" variant="outlined" onClick={(e) => { Downloadpdf() }} >PDF</Button>
                                                ...
                                                {spinnerforfetchingcsv ?
                                                    ...
                                                    <>
                                                        ...
                                                        >
                                                            <Button size="medium" color="info" variant="outlined" onClick={(e) => { setFetchingdataflag(false) }} >CSV</Button>
                                                        </CSVLink>
                                                    </>
                                                }
                                            ...
                                            :
                                            <><Button size="medium" color="info" variant="outlined" onClick={generate} >generate</Button></>
