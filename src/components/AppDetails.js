                                    ...
                                    <div align="right" style={{ position: 'relative' }}>
                                        <Box sx={{ minWidth: 180 }}>
                                            {/* <FormControl style={{ minWidth: 180 }} size="small">
                                                <InputLabel id="demo-simple-select-label" style={{color:theme.typography.primary.app,top:'0px'}}>Department List</InputLabel>
                                                <Select
                                            ...
                                            <FormControl sx={{ minWidth: 180 }} size="small">
                                                <InputLabel htmlFor="grouped-native-select">Department List</InputLabel>
                                                <Select native defaultValue={department.dept_code} id="grouped-native-select" label="Department List"
                                                    // value={department.dept_code}
                                                    ...
                                                    <option value={department.dept_code} style={{ color: theme.typography.primary.paragraphbody, backgroundColor: theme.dropdownbg.backgroundColor }}> {department.dept_name} </option>
                                ...
                                <Grid item lg={6} style={{}}>
                                    ...
                                    <div align="left">
                                        <Box sx={{ minWidth: 180 }}>
                                            ...
                                            <FormControl sx={{ minWidth: 180 }} size="small">
                                                <InputLabel htmlFor="grouped-native-select">Application List</InputLabel>
                                                <Select native defaultValue={appname} id="grouped-native-select" label="Application List"
                                                    // value={appname}
                                                    ...
                                                    {applist.map((item, index) => (
                                                        <option key={index} value={item?.appcode} style={{ color: theme.typography.primary.paragraphbody, backgroundColor: theme.dropdownbg.backgroundColor }}>
                                                            {item?.appname}
                                                        </option>
                                                    ))
                                                    }
